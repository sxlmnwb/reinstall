...
set confhome=https://raw.githubusercontent.com/sxlmnwb/reinstall/main
set confhome_cn=https://cnb.cool/sxlmnwb/reinstall/-/git/raw/main
rem set confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/sxlmnwb/reinstall/main
